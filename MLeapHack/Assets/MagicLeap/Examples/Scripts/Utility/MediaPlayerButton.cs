...
namespace MagicLeap
{
    ...
    public class MediaPlayerButton : MonoBehaviour
    {
        ...
        protected virtual void OnEnable()
        {
            ...
            {
                if (string.Compare(gameObject.name, "Rewind10") == 0)
                {
                    TranscriptManager._instance.BacktrackTranscript();
                }
                else if (string.Compare(gameObject.name, "Forward10") == 0)
                {
                    TranscriptManager._instance.FastForwardTranscript();
                }
            }
        }
        #endregion
